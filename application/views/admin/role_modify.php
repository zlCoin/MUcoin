                                        ...
                                        <div class="col-lg-12">
                                            <section class="panel">
                                                <div class="panel-body">
                                                    <form id="theForm" name="theForm" role="form" class="form-horizontal bordered-group"  method="post" action="<?=site_url('/admin/role/modify_submit')?>">
														...
														<div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control" rows="3" name="purview" id="purview"><?=$row->purview?></textarea>
                                                            </div>
                                                        </div>  
														<div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
																...
																<input type="hidden" id="id" name="id" value="<?=$row->role_id?>">
                                                            </div>
                                                        </div>  

				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<?
											if($row->state!=2){	
											?>
						<a class="btn btn-danger"  href="<?=site_url('admin/electronic_currency_market/cancel/'.$row->electronic_currency_market_id)?>" onclick="javascript:return confirm('确定取消吗？');">取消</a><?
											}else{
											echo "--";
											}
											?></td>

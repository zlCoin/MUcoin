                                        ...
                                        <div class="col-lg-12">
                                            <section class="panel">
                                                <div class="panel-body">
                                                    <form id="theForm" name="theForm" role="form" class="form-horizontal bordered-group"  method="post" action="<?=site_url('/admin/help/modify_submit')?>">
														...
														<div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
																...
																<input type="hidden" id="id" name="id" value="<?=$row->help_id?>">
                                                            </div>
                                                        </div>  

		...
		<section class="main-content">
			<header class="header navbar bg-default">
				...
				<ul class="nav navbar-nav" style="float:right;">
					<li style="width:120px">
						<a href="<?=site_url('admin/help/add')?>" class="btn btn-warning">新增</a>
					</li>		
				</ul>
			</header>
			<div class="content-wrap">
				<div class="row">
					<div class="col-md-12">
						<section class="panel">
							<form class="form-inline" method="post" name="searchForm" id="searchForm" action="<?=site_url('admin/help')?>">
								<ol class="breadcrumb">
										...
										<tbody>
											...
											<tr>
												...
												<td style="text-align:center;">
													<a href="<?=site_url('admin/help/modify/'.$row->help_id)?>" class="btn btn-info">编辑</a>
													<a href="<?=site_url('admin/help/delete/'.$row->help_id)?>" class="btn btn-danger" onclick="javascript:return del_sure();">删除</a>
												</td>
											</tr>											
											<? } ?>
										</tbody>
